                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="email" id="email" required="true" value="" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Mobile Number:</label>
                        <input type="text" name="mobnum" id="mobnum" required="true" value="" class="form-control" maxlength="10" pattern="[0-9]+">
                      </div>
