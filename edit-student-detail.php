...
<option value=""></option>
                      ...
                      <div class="form-group">
                        ...
                        <img src="images/" width="100" height="100" value=""><a href=""> &nbsp; Edit Image</a>
                      </div>
                    </div>
                      <div class="col-6">
...
<div class="form-group">
                        ...
                        <input type="text" name="uname" value="" class="form-control" readonly='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Password</label>
                        <input type="Password" name="password" value="" class="form-control" readonly='true'>
                      </div>
